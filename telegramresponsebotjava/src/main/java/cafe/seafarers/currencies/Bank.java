...
public class Bank {
	...
	/**
	 * Adds a positive integer amount to an existing users account If the account
	 * doesn't exist, creates one and adds the amount
	 * 
	 * @param userName the user tied to this account
	...
	/**
	 * Subtracts a positive amount from a users account so long as it is less than
