...
public class BankManager {
	...
	/**
	 * Charges a positive amount from an account, so long as the account possesses
	 * that amount
	 * 
	 * @param userName
	 * @param amount   a positive integer
	...
	/**
	 * Returns the amount contained within the provided account. Returns 0 if the
	 * account doesn't exist and then creates one for the user
	 * 
	 * @param userName
