...
public class RollPlugin implements BotPlugin {
    ...
    public BaseRequest onCommand(Update update) {
        ...
        try {
            ...
            e.printStackTrace();
            return new SendMessage(update.message().chat().id(), "Roll: Sorry, something went wrong when parsing your syntax! Please use /help Rolls to learn how to use this plugin.");
        }
