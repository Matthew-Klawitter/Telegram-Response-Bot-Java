...
public class VapePlugin implements BotPlugin {
    ...
    public BaseRequest onCommand(Update update) {
        ...
        if (penFuel.get(user) <= 0){
            return new SendMessage(channelID, user + " tries to vape, but their pen was out of juice! You need to use /vrefill before vaping again");
        }
        ...
        switch (vapeLevel){
            ...
            case 1:
                ...
                return new SendMessage(channelID, user + " tries to breath in the vape, but their pen is empty! How foolish.");
            case 2:
            ...
            case 3:
                ...
                return new SendMessage(channelID, user + " takes a swig of vape, and breaths out a respectable cloud. Nice!");
            case 4:
                penFuel.replace(user, penFuel.get(user) - 4);
                return new SendMessage(channelID, user + " takes a swig of vape, and breaths out one heck of a cloud! Siiick!");
            case 5:
            ...
            case 7:
                ...
                return new SendMessage(channelID, user + " has followed the ways of the vapnatman. They hide themselves within their vape.");
            case 8:
                penFuel.replace(user, penFuel.get(user) - 8);
                return new SendMessage(channelID, user + " has become vape itself. With every breath they let out the sickest vape cloud. No one can match them.");
            case 9:
            ...
            case 10:
                ...
                return new SendMessage(channelID, user + " can't decide which flavor they like. They waste a lot of their vape.");
            case 11:
            ...
            case 17:
                ...
                return new SendMessage(channelID, user + " cloaked themselves in their vape of invisibility. There is vape everywhere.");
            case 18:
