...
public interface BotPlugin {
	...
	/**
	 * Run every time the bot recieves a message, if this plugin has message access
	 * 
	 * @param update
	 * @return
	 */
	...
	/**
	 * Returns a list of commands that when received by Telegram run this plugin's
	 * onCommand method
	 * 
	 * @return Array String
	 */
