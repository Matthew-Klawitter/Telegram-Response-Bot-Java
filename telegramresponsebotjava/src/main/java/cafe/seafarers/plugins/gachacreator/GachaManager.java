...
public class GachaManager {
	...
	/**
	 * Charges the user a set amount. If the charge goes through, a randomly
	 * generated Gacha is added to their account
	 * 
	 * @param username
	 ...
	 * @param toUser
	 * @param id
	 * @return true if the gacha is successfully added to toUser's list and removed
	 *         from fromUser's list
	 */
