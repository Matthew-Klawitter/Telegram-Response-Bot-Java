...
public class GachaFight {
    ...
    public String singlesFight(Gacha p1, Gacha p2) {
        ...
        br.append("In one corner, we have ").append(p1.getName()).append("! In the other, ").append(p2.getName()).append("!\n");
        ...
        if (p1.getSpeed() > p2.getSpeed()){
            ...
            br.append("We have ").append(attacker.getName()).append(" starting off by quickly approaching their opponent!");
        }
        else {
            attacker = p2;
            defender = p1;
        ...
        while (appliedEffects.get(attacker)[0] > attacker.getHealth() && appliedEffects.get(defender)[0] > defender.getHealth()){
            String t = "";
            ...
            // Checks if the attack this round is a special attack for the attacker (undodgeable/uncounterable)
    ...
    public String attack(Gacha attacker, Gacha defender) {
        ...
        if (appliedEffects.get(attacker)[7] > 0){
            br.append(attacker.getName()).append(" is asleep! ").append(defender.getName()).append(" takes this time to heal.\n");
        ...
        if (appliedEffects.get(attacker)[10] > 0){
            ...
            if (appliedEffects.get(defender)[10] > 0){
                br.append("But... ").append(defender.getName()).append(" uses their angelic form to neutralize the demonic strenght!\n");
                dmgMultiplier = .5f;
            }
        }
        ...
        if (appliedEffects.get(defender)[7] > 0){
            br.append(defender.getName()).append(" is asleep! ").append(attacker.getName()).append(" takes this time to heal.\n");
        ...
        br.append(attacker.getName()).append(" launches their attack and ").append(attackPhrases[r.nextInt(attackPhrases.length)]).append("!\n");
    ...
    public String applyEffects(Gacha attacker, Gacha defender) {
        ...
        // 9 = doom chance either 1 through 3 for opponent, sets health to 0 after it his 3
